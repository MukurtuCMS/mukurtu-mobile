    ...
    render() {
        ...
        for (var i = 0; i < this.state.count; i++) {
            ...
            autocompleteFields.push(<Autocomplete
                ...
                renderItem={({item}) => (
                    <TouchableOpacity onPress={() => this.props.setFormValue(this.props.fieldName, item.text, valueKey, key)}>
        ...
        return (
            <View style={styles.container}>
                ...
                {autocompleteFields}
                <Button title={'Add another'} onPress={() => this.setState({count: this.state.count + 1})} />
            </View>
        );
    }
}
